...
const EmailLinking: React.FC = () => {
  ...
  const providers = [
    { name: 'Google Workspace / Gmail', icon: 'https://cdn-icons-png.flaticon.com/512/2991/2991148.png', color: 'bg-red-50' },
    { name: 'Microsoft Outlook / 365', icon: 'https://cdn-icons-png.flaticon.com/512/732/732223.png', color: 'bg-blue-50' },
    { name: 'Outro (IMAP/SMTP)', icon: '', color: 'bg-gray-50' }
  ];
      ...
      <div className="h-full flex flex-col items-center justify-center p-8 bg-[#f3f4f6]">
         <div className="max-w-xl w-full space-y-12 animate-fade-in">
            <div className="text-center space-y-4">
               ...
               <h2 className="text-3xl font-black text-gray-900 tracking-tight">Vincular Conta de Email</h2>
               <p className="text-gray-500 font-medium">Ligue o seu email para que o Agente IA possa recolher faturas automaticamente.</p>
            </div>
               ...
               {step === 1 ? (
                 ...
                 <div className="space-y-8 animate-fade-in">
                    <div className="space-y-4">
                       ...
                       <div className="relative group">
                          ...
                          <input 
                            ...
                            className="w-full h-16 bg-gray-50 border border-gray-100 rounded-[28px] pl-16 pr-6 font-bold text-lg text-gray-900 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500/20 outline-none transition-all placeholder:text-gray-300 shadow-inner"
                          />
                       </div>
                    </div>
                    ...
                    <div className="flex space-x-4">
                       <button onClick={() => setStep(1)} className="px-8 h-16 bg-gray-50 text-gray-400 rounded-[28px] font-bold text-sm hover:bg-gray-100 transition-all active:scale-95">Voltar</button>
                       <button 
                         onClick={() => alert('Sincronizando conta...')}
                         className="flex-1 h-16 bg-blue-600 text-white rounded-[28px] font-bold text-sm shadow-xl shadow-blue-500/20 flex items-center justify-center space-x-3 hover:bg-blue-700 active:scale-95 transition-all"
                       >
