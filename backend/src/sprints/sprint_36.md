# Sprint 36: Front-end: UI Tela de Inbox - Hub de Correspondências

## 📌 Contexto Estratégico
- **Fase Arquitetural:** Front-end Módulos Visuais
- **Objetivo da Sprint:** Interface vital reproduzindo a UX de um email tradicional focado em finanças, permitindo leitura das extrações em lote.
