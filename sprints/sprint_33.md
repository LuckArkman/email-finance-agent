# Sprint 33: Setup do Repositório do Frontend: Vite + Vue3/React

## 📌 Contexto Estratégico
- **Fase Arquitetural:** Front-end SPA Setup
- **Objetivo da Sprint:** Construir a estrutura base em Javascript/TypeScript provendendo compilação rápida HMR e robustez estática.
...
- Vite, TypeScript, Vue3 ou React18
